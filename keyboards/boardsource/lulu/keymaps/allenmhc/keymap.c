 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_RCTL,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOTE,
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, XXXXXXX, QK_BOOT, _______, _______, _______, _______, _______, _______,
...
const uint16_t PROGMEM home_combo[] = { CKC_V, KC_B, COMBO_END };
const uint16_t PROGMEM end_combo[] = { KC_N, CKC_M, COMBO_END };
const uint16_t PROGMEM pageup_combo[] = { KC_SPC, KC_DOWN, COMBO_END };
const uint16_t PROGMEM pagedown_combo[] = { KC_DOWN, LOWER, COMBO_END };
...
void on_smtd_action(uint16_t keycode, smtd_action action, uint8_t tap_count) {
    switch (keycode) {
        ...
        SMTD_MT(CKC_SLSH, KC_SLSH, KC_LCTL)
    }
}